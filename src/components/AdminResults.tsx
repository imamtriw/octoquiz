  ...
  return (
    <div className="min-h-[calc(100vh-80px)] p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-8 relative z-10">
      ...
      <div className={`${resultMode === 'GROUP' ? '' : 'hidden'} bg-[#0e172a]/95 border border-cyan-500/20 rounded-3xl p-6 shadow-xl`}>
        ...
        <div className="relative flex flex-col md:flex-row items-end justify-center gap-4 sm:gap-6 mb-6 pt-10 pb-2 max-w-3xl mx-auto">{teamResults.slice(0, 3).map((team, index) => <div key={team.name} className={`w-full md:w-1/3 flex flex-col items-center ${index === 0 ? 'order-1 md:order-2' : index === 1 ? 'order-2 md:order-1' : 'order-3'}`}><div className="relative mb-2">{index === 0 ? <Crown className="w-9 h-9 text-amber-400 animate-bounce mx-auto mb-1" /> : <Medal className={`w-8 h-8 mx-auto mb-1 ${index === 1 ? 'text-slate-300' : 'text-amber-500'}`} />}<div className={`rounded-2xl flex items-center justify-center text-4xl shadow-2xl border-2 ${index === 0 ? 'w-20 h-20 bg-gradient-to-br from-yellow-300 via-amber-400 to-amber-600 border-white shadow-yellow-500/40' : index === 1 ? 'w-16 h-16 bg-gradient-to-br from-slate-200 to-slate-400 border-white/40' : 'w-16 h-16 bg-gradient-to-br from-amber-600 to-amber-800 border-white/30'}`}>🏆</div><div className={`absolute -bottom-2 -right-2 rounded-full text-black font-black flex items-center justify-center border border-white ${index === 0 ? 'w-8 h-8 bg-amber-400 text-sm' : 'w-7 h-7 bg-slate-300 text-xs'}`}>{index + 1}</div></div><span className="text-sm font-extrabold text-white text-center truncate max-w-full">{team.name}</span><span className="text-xs text-cyan-300 text-center">{team.members} anggota • {team.accuracy}%</span><span className="text-sm font-black text-emerald-300 mt-1">{team.score.toLocaleString('id-ID')} pts</span><div className={`w-full rounded-t-2xl mt-3 flex flex-col items-center justify-center p-3 ${index === 0 ? 'h-36 sm:h-44 bg-gradient-to-t from-[#060a14] via-[#241a08] to-[#45310d] border-t-4 border-amber-400' : index === 1 ? 'h-28 sm:h-32 bg-gradient-to-t from-[#060a14] via-[#0b1323] to-[#1a2b4a] border-t-2 border-slate-300/40' : 'h-24 sm:h-28 bg-gradient-to-t from-[#060a14] via-[#1f150e] to-[#3a2517] border-t-2 border-amber-600/40'}`}><span className={`text-2xl font-black font-display ${index === 0 ? 'text-amber-400' : index === 1 ? 'text-slate-300' : 'text-amber-500'}`}>{index + 1}st</span></div></div>)}<div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[92%] h-5 rounded-full bg-gradient-to-r from-cyan-500/10 via-amber-400/30 to-cyan-500/10 border border-amber-300/20" /></div>
